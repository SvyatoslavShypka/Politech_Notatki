...
import static eu.dar3.notatki.util.Constants.LOG_LEVEL;
import static eu.dar3.notatki.util.Constants.LOG_PATTERN;
import static eu.dar3.notatki.util.Constants.LOG_ENCODING;
import static eu.dar3.notatki.util.Constants.LOG_FILE;
import static eu.dar3.notatki.util.Constants.LOG_FILE_NAME_PATTERN;
import static eu.dar3.notatki.util.Constants.DEFAULT_APP_FILE_NAME;
